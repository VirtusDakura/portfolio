...
const ServiceCard = ({ service }) => {
    ...
    return (
        <div className="group/card relative bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/80 rounded-2xl p-5 sm:p-7 hover:border-indigo-500/40 transition-all duration-300 flex flex-col justify-between h-full overflow-hidden cursor-pointer shadow-lg hover:shadow-[0_0_30px_rgba(99,102,241,0.15)]">
            ...
            <div>
                ...
                <div className='flex items-center gap-3 mb-3.5'>
                    <div className='w-10 h-10 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-lg shrink-0 group-hover/card:bg-indigo-500/20 group-hover/card:border-indigo-500/40 transition-colors duration-300'>
                        {getMainIcon(service.icon)}
                    </div>
                    <h3 className='text-lg sm:text-xl font-bold text-white tracking-tight group-hover/card:text-indigo-300 transition-colors duration-200 leading-snug'>
                        {service.title}
                    </h3>
                </div>
