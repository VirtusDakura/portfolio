                        ...
                        <h2 className='text-4xl font-bold text-center mb-12'>Contact Me</h2>
                            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                                    <div className='flex-1'>
                                        ...
                                        <p>I'm opened to learning new things and all forms of collaboration</p>

                                        <div className='mb-4 mt-8'>
                                            <FaEnvelope className='inline-block text-green-400 mr-2'>
                                            </FaEnvelope>
                                            <a href='mailto:dakuravirtus@gmail.com' className='hover:underline'>dakuravirtus@gmail.com</a>
                                        </div>

                                        <div className='mb-4'>
                                            <FaPhone className='inline-block text-green-400 mr-2'>
                                            </FaPhone>
                                            <span>+2330596621148</span>
                                        </div>
                                        ...
                                        <form className='space-y-4'>
                                            ...
                                            <div>
                                             ...
                                             <div>
                                                ...
                                                <textarea type='text' className='w-full p-2 rounded bg-gray-800 border border-gray-600 focus:outline-none focus:border-green-400'  rows='5'placeholder='Enter Your Message'/>
                                            </div>
